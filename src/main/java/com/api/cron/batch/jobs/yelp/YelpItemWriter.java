 ...
 *
 */
@Component("yelp2ItemWriter")
@Scope("step")
public class YelpItemWriter implements ItemWriter<BaseItem>{
	private final static Logger logger = Logger.getLogger(YelpItemWriter.class);
